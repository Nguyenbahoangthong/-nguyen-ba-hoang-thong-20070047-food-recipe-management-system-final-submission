...
class FoodRecipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_recipe" do
    assert_difference("FoodRecipe.count") do
      post food_recipes_url, params: { food_recipe: { author_id: @food_recipe.author_id, description: @food_recipe.description, food_id: @food_recipe.food_id, ingredient_id: @food_recipe.ingredient_id, instruction: @food_recipe.instruction } }
    end
  ...
  test "should update food_recipe" do
    patch food_recipe_url(@food_recipe), params: { food_recipe: { author_id: @food_recipe.author_id, description: @food_recipe.description, food_id: @food_recipe.food_id, ingredient_id: @food_recipe.ingredient_id, instruction: @food_recipe.instruction } }
